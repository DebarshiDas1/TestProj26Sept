...
using TestProj26Sept.Entities;

namespace TestProj26Sept.Data
{
    /// <summary>
    /// Represents the database context for the application.
    /// </summary>
    public class TestProj26SeptContext : DbContext
    {
        /// <summary>
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-7723PEB\\SQLEXPRESS;Initial Catalog=T631688_TestProj26Sept;Persist Security Info=True;user id=sa;password=123456;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
