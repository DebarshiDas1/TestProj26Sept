using TestProj26Sept.Models;
using TestProj26Sept.Data;
using TestProj26Sept.Filter;
using TestProj26Sept.Entities;
using TestProj26Sept.Logger;
...
namespace TestProj26Sept.Services
{
    /// <summary>
    ...
    {
        private readonly TestProj26SeptContext _dbContext;
        ...
        public RoleEntitlementService(TestProj26SeptContext dbContext, IFieldMapperService mapper)
        {
