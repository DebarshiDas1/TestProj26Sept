...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "TestProj26Sept", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<TestProj26SeptContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "TestProj26Sept API v1");
